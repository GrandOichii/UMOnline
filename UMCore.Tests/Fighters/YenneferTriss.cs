...
public class YenneferTrisTests
{
    private static LoadoutTemplateBuilder GetLoadoutBuilder() => new LoadoutTemplateBuilder("Yennefer & Triss")
        .Load("../../../../.generated/loadouts/Yennefer & Triss/Yennefer & Triss.json")
        .ClearDeck();

    [Fact]
    public async Task YenneferAttack_Decline()
    {
        // Arrange
    ...
    [Fact]
    public async Task YenneferAttack_Accept()
    {
        // Arrange
        var config = new MatchConfigBuilder()
            .InitialHandSize(2)
